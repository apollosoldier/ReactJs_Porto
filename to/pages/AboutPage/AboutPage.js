      ...
      <div className="content-grid">
        ...
        <div className="about-wrapper">
          <div className="about-content" style={{ color: textPrimary }}>
            <p>
              Hi my name is <span className="highlight">Mohamed TRAORE</span> i am currently a engineer student in Embedded System at <span className="highlight">ESIREM Dijon</span>
            </p>
            <p>
              I like <span className="highlight">DataTronics, Embedded System, Machine Learning </span>  and
              <span className="highlight">UAV DRONE </span>
            </p>
            <p>
              ...
              <span className="highlight">blog</span> what I learn and share my travels pictures.
            </p>
            <p>
